...
import { Modal, View, Text ,TouchableWithoutFeedback, Image,StyleSheet } from 'react-native';
        ...
        <View style = {styles.mainContainer}>
          ...
          <View style = {styles.contentContainer}>
              ...
              <View style = {[styles.achievmentNameContainer, GlobalStyles.center]}>
                <Text style={[GlobalStyles.textAchievment, GlobalStyles.bold, GlobalStyles.white]} >COOK</Text>
              </View>
