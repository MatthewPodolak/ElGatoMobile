  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.questionHeaderContainer}>
        <Text style={styles.questionaryText}>HOW MANY DAYS PER WEEK DO YOU TRAIN?</Text>
      </View>
      <View style={styles.questionaryAnswerSection}>
        ...
        >
          ...
          <Text style={styles.optionText}>1-2</Text>
        </Pressable>
        <Pressable
          style={[
            styles.option,
        ...
        >
          ...
          <Text style={styles.optionText}>3-4</Text>
        </Pressable>
      </View>
      <View style={styles.questionaryAnswerSection}>
        <Pressable
        ...
        >
          <Image source={FemaleImage} style={styles.genderImage} />
          <Text style={styles.optionText}>6-7</Text>
        </Pressable>
      </View>
